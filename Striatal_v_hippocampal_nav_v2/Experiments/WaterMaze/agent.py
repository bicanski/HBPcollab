import numpy as np
from Experiments.WaterMaze.hippocampus import TDHippocampus
from Experiments.WaterMaze.striatum import TDStriatum
from environments import WaterMazeEnv, PlusMaze
from hebbian_hippocampus import Hippocampus
